...
require (
	...
	github.com/percona/everest-operator v0.6.0-dev1.0.20251218081526-c77ea4a7ec14
	github.com/percona/percona-helm-charts/charts/everest v0.0.0-20251217064918-f7a7254a9533
