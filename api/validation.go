...
func (e *EverestServer) validateDatabaseClusterOnCreate(
	...
	if len(schedules) > 0 {
		if err := e.enforceOrErr(user, rbac.ResourceDatabaseClusterBackups, rbac.ActionCreate, rbac.ObjectName(namespace, "")); err != nil {
			return err
		}
	}
...
func (e *EverestServer) validateBackupScheduledUpdate(
	...
	if !isSchedulesEqual() {
		if err := e.enforceOrErr(user, rbac.ResourceDatabaseClusterBackups, rbac.ActionCreate, rbac.ObjectName(oldDB.GetNamespace(), "")); err != nil {
			return err
		}
	}
	return nil
