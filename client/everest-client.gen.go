...
type ClientInterface interface {
	...
	// UpgradeDatabaseEngineOperatorVersion request
	UpgradeDatabaseEngineOperatorVersion(ctx context.Context, namespace string, name string, targetVersion string, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) UpgradeDatabaseEngineOperatorVersion(ctx context.Context, namespace string, name string, targetVersion string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpgradeDatabaseEngineOperatorVersionRequest(c.Server, namespace, name, targetVersion)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewUpgradeDatabaseEngineOperatorVersionRequest generates requests for UpgradeDatabaseEngineOperatorVersion
func NewUpgradeDatabaseEngineOperatorVersionRequest(server string, namespace string, name string, targetVersion string) (*http.Request, error) {
	var err error
	...
	pathParam2, err = runtime.StyleParamWithLocation("simple", false, "targetVersion", runtime.ParamLocationPath, targetVersion)
	if err != nil {
		return nil, err
	}
	...
	operationPath := fmt.Sprintf("/namespaces/%s/database-engines/%s/operator-upgrade/%s", pathParam0, pathParam1, pathParam2)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// UpgradeDatabaseEngineOperatorVersionWithResponse request
	UpgradeDatabaseEngineOperatorVersionWithResponse(ctx context.Context, namespace string, name string, targetVersion string, reqEditors ...RequestEditorFn) (*UpgradeDatabaseEngineOperatorVersionResponse, error)
...
type UpgradeDatabaseEngineOperatorVersionResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON400      *Error
	JSON500      *Error
...
// Status returns HTTPResponse.Status
func (r UpgradeDatabaseEngineOperatorVersionResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r UpgradeDatabaseEngineOperatorVersionResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// UpgradeDatabaseEngineOperatorVersionWithResponse request returning *UpgradeDatabaseEngineOperatorVersionResponse
func (c *ClientWithResponses) UpgradeDatabaseEngineOperatorVersionWithResponse(ctx context.Context, namespace string, name string, targetVersion string, reqEditors ...RequestEditorFn) (*UpgradeDatabaseEngineOperatorVersionResponse, error) {
	rsp, err := c.UpgradeDatabaseEngineOperatorVersion(ctx, namespace, name, targetVersion, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUpgradeDatabaseEngineOperatorVersionResponse(rsp)
}
...
// ParseUpgradeDatabaseEngineOperatorVersionResponse parses an HTTP response from a UpgradeDatabaseEngineOperatorVersionWithResponse call
func ParseUpgradeDatabaseEngineOperatorVersionResponse(rsp *http.Response) (*UpgradeDatabaseEngineOperatorVersionResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &UpgradeDatabaseEngineOperatorVersionResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
