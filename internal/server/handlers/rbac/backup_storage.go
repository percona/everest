...
func (h *rbacHandler) ListBackupStorages(ctx context.Context, cluster, namespace string) (*everestv1alpha1.BackupStorageList, error) {
...
func (h *rbacHandler) GetBackupStorage(ctx context.Context, cluster, namespace, name string) (*everestv1alpha1.BackupStorage, error) {
...
func (h *rbacHandler) CreateBackupStorage(ctx context.Context, cluster, namespace string, req *api.CreateBackupStorageParams) (*everestv1alpha1.BackupStorage, error) {
...
func (h *rbacHandler) UpdateBackupStorage(ctx context.Context, cluster, namespace, name string, req *api.UpdateBackupStorageParams) (*everestv1alpha1.BackupStorage, error) {
