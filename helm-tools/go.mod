module github.com/percona/everest/helm-tools

go 1.22.6

require (
	github.com/go-logr/zapr v1.3.0
	github.com/percona/everest v1.1.1
...
require (
	...
	github.com/operator-framework/operator-lifecycle-manager v0.27.0 // indirect
	github.com/operator-framework/operator-registry v1.35.0 // indirect
	github.com/percona/everest-operator v1.1.1 // indirect
