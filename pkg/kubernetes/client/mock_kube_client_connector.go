...
// Clientset provides a mock function with no fields
...
// ClusterName provides a mock function with no fields
...
// CreateDatabaseClusterRestore provides a mock function with given fields: ctx, namespace, restore
func (_m *MockKubeClientConnector) CreateDatabaseClusterRestore(ctx context.Context, namespace string, restore *v1alpha1.DatabaseClusterRestore) (*v1alpha1.DatabaseClusterRestore, error) {
	ret := _m.Called(ctx, namespace, restore)
...
func (_m *MockKubeClientConnector) CreateMonitoringConfig(ctx context.Context, config *v1alpha1.MonitoringConfig) (*v1alpha1.MonitoringConfig, error) {
...
// DeleteDatabaseClusterBackup provides a mock function with given fields: ctx, namespace, name
func (_m *MockKubeClientConnector) DeleteDatabaseClusterBackup(ctx context.Context, namespace string, name string) error {
	ret := _m.Called(ctx, namespace, name)
...
func (_m *MockKubeClientConnector) DeleteDatabaseClusterRestore(ctx context.Context, namespace string, name string) error {
	ret := _m.Called(ctx, namespace, name)
...
// OLM provides a mock function with no fields
...
func (_m *MockKubeClientConnector) UpdateBackupStorage(ctx context.Context, storage *v1alpha1.BackupStorage) (*v1alpha1.BackupStorage, error) {
	ret := _m.Called(ctx, storage)
...
// UpdateDatabaseClusterRestore provides a mock function with given fields: ctx, namespace, restore
func (_m *MockKubeClientConnector) UpdateDatabaseClusterRestore(ctx context.Context, namespace string, restore *v1alpha1.DatabaseClusterRestore) (*v1alpha1.DatabaseClusterRestore, error) {
	ret := _m.Called(ctx, namespace, restore)
...
func (_m *MockKubeClientConnector) UpdateMonitoringConfig(ctx context.Context, config *v1alpha1.MonitoringConfig) (*v1alpha1.MonitoringConfig, error) {
	ret := _m.Called(ctx, config)
